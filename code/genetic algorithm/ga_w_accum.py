...
"""
The genetic algorithm using the modified fitness function that accumulates fitness over the test run
"""
...
def run_GA():
    ...
    for i in range(5):
        # initialise the population and data structures
        best_fitnesses = []
        average_fitnesses = []
...
def run_bot(agent):
    ...
    Returns the accumulated fitness
    """
...
def initialise_pop(random, zeroes):
    ...
    for i in range(random):
        ...
        _, fitness = run_bot(agent) # test the agent for its fitness
